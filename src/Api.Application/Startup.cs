...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Environment.SetEnvironmentVariable("DB_CONNECTION", "Server=.\\SQLEXPRESS2019;Initial Catalog=dbapi_integration;MultipleActiveResultSets=true;User ID=sa;Password=pwd!0407@");
